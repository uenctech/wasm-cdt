...
namespace wasm {
   ...
   namespace internal_use_do_not_use {
      extern "C" {
         ...
         __attribute__((wasm_wasm_import))
         int64_t call_with_return(char *serialized_transaction, size_t size);
      }
   };



   inline uint64_t call(char *serialized_transaction, size_t size){
      return internal_use_do_not_use::call( serialized_transaction, size );
   }

   inline int64_t call_with_return(char *serialized_transaction, size_t size){
      return internal_use_do_not_use::call_with_return( serialized_transaction, size );
   }
    ...
    */
   inline void require_auth(void* account, uint32_t len) {
      internal_use_do_not_use::require_auth( account, len );
   }
   ...
   */
    ...
    */
   inline bool is_account(void* account, uint32_t len) {
      return internal_use_do_not_use::is_account( account, len);
   }
