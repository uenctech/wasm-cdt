...
public:
	...
	static constexpr auto transform_indices( ) {
		//类型为  hana::make_tuple(
		//			hana::make_tuple(0, indexed_by<"by_owner"_n, const_mem_fun<account, regid, &account::get_owner>>)
		//       	hana::make_tuple(1, indexed_by<"by_code"_n, const_mem_fun<account, uint64_t, &account::get_symbol_code>>)
		//          ...
		//        )
